...
A token is issued by the server to tell who the client is and what permissions they have

- [ ] What steps can you take in your web apps to keep your data secure?

tokens and private routes 

- [ ] Describe how web servers work.

web browsers request info from webserver and the webserver passes information based on permissions and tokens
